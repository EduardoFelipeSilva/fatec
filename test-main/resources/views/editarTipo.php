...
$tipo = TipoDao::selectById($_POST['id']);
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
            ...
            <main class="content col-12 col-md-10">
                <div class="page-header">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        ...
                        <h1 class="m-0">Editar Tipo</h1>
                        </div>
                        <p class="text-muted m-0" style="padding-left: 52px;">Preencha o formulário abaixo para editar o tipo!</p>
                </div>
                    ...
                    <div class="form-section">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="nome" name="nome" value="<?= $tipo['nome'] ?>" placeholder="Nome do Tipo" required>
                            </div>
                        
                        </div>
                    
                        <div class="form-actions">
                            <button type="submit" class="btn-submit">Atualizar Tipo</button>
                        </div>
                    </div>
                </form>
            </main>
