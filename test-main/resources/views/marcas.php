...
$buscaMarca = $_GET['buscaMarca'] ?? '';
$ordenarPor = $_GET['ordenarPor'] ?? 'id_marca';
$ordem = $_GET['ordem'] ?? 'DESC';

$marcas = MarcaDao::selectDashboard(
    $inicio,
    $limite,
    $buscaMarca,
    $ordenarPor,
...
$totalMarcas = MarcaDao::totalDashboard($buscaMarca);
$totalPaginas = max(1, ceil($totalMarcas / $limite));
    ...
    <main class="content">
        ...
        <header class="main-header">
            ...
            <div class="header-left">
                ...
                <p class="text-muted m-0" style="padding-left: 52px;">Abaixo estão as marcas cadastradas no sistema.</p>
            </div>

            <a class="dropdown-item" href="cadastroMarca.php">
            <div class="dropdown">
                ...
                <form method="GET" class="table-controls">
                    ...
                    <div class="search-box small">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($buscaMarca) ?>"
                        >
                    </div>

                    <select name="ordenarPor" class="form-select">
                        <option value="id_marca" <?= ($ordenarPor == 'id_marca') ? 'selected' : '' ?>>
                            ID
                        </option>
            ...
            <div class="table-responsive">
                        ...
                        <?php foreach($marcas as $marca): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button
                                        type="button"
                                        class="icon-action delete border-0 bg-transparent btnDeletarMarca"

                                        data-bs-toggle="modal"
                                        data-bs-target="#modalDeleteMarca"

                                        data-id="<?= $marca['id_marca'] ?>"
                                        data-nome="<?= htmlspecialchars($marca['nome']) ?>"
                ...
                <div class="table-footer">
                    ...
                    <div class="pagination-controls">
                        ...
                        <?php if($pagina > 1): ?>
                            <a href="?pagina=<?= $pagina - 1 ?>&buscaMarca=<?= urlencode($buscaMarca) ?>&ordenarPor=<?= $ordenarPor ?>&ordem=<?= $ordem ?>" class="page-link">
                                <span class="material-icons">chevron_left</span>
                            </a>
                        <?php endif; ?>

                        <?php for($i = 1; $i <= $totalPaginas; $i++): ?>
                            <a href="?pagina=<?= $i ?>&buscaMarca=<?= urlencode($buscaMarca) ?>&ordenarPor=<?= $ordenarPor ?>&ordem=<?= $ordem ?>"
...
<div class="modal fade" id="modalDeleteMarca" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-body text-center p-4">
                ...
                <p class="text-muted mt-2">
                    Marca:
                    <strong id="deleteNomeMarca"></strong>
                </p>
            ...
            <div class="modal-footer">
                ...
                <form action="../controller/controllerMarca.php" method="POST">

                    <input type="hidden" name="id" id="deleteIdMarca">
...
<script>
const botoesDelete = document.querySelectorAll('.btnDeletarMarca');
...
botoesDelete.forEach(botao => {
    botao.addEventListener('click', function () {
        ...
        document.getElementById('deleteIdMarca').value = id;
        document.getElementById('deleteNomeMarca').innerText = nome;
    });
});
</script>
