...
$buscaTipo = $_GET['buscaTipo'] ?? '';
$ordenarPor = $_GET['ordenarPor'] ?? 'id_tipo';
$ordem = $_GET['ordem'] ?? 'DESC';

$tipos = TipoDao::selectDashboard(
    $inicio,
    $limite,
    $buscaTipo,
    $ordenarPor,
...
$totalTipos = TipoDao::totalDashboard($buscaTipo);
$totalPaginas = max(1, ceil($totalTipos / $limite));
    ...
    <main class="content">
        ...
        <header class="main-header">
            ...
            <div class="header-left">
                ...
                <h1 class="m-0">Tipos</h1>
                </div>
                <p class="text-muted m-0" style="padding-left: 52px;">Abaixo estão os Tipos cadastrados no sistema.</p>
            </div>

            <a class="dropdown-item" href="cadastroTipo.php">
            <div class="dropdown">
                ...
                <form method="GET" class="table-controls">
                    ...
                    <div class="search-box small">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($buscaTipo) ?>"
                        >
                    </div>

                    <select name="ordenarPor" class="form-select">

                        <option value="id_tipo" <?= ($ordenarPor == 'id_tipo') ? 'selected' : '' ?>>
                            ID
                        </option>
            ...
            <div class="table-responsive">
                        ...
                        <?php foreach($tipos as $tipo): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button
                                        type="button"
                                        class="icon-action delete border-0 bg-transparent btnDeletarTipo"

                                        data-bs-toggle="modal"
                                        data-bs-target="#modalDeleteTipo"
                ...
                <div class="table-footer">
                    ...
                    <div class="pagination-controls">
                        ...
                        <?php if($pagina > 1): ?>
                            <a href="?pagina=<?= $pagina - 1 ?>&buscaTipo=<?= urlencode($buscaTipo) ?>&ordenarPor=<?= $ordenarPor ?>&ordem=<?= $ordem ?>" class="page-link">
                                <span class="material-icons">chevron_left</span>
                            </a>
                        <?php endif; ?>

                        <?php for($i = 1; $i <= $totalPaginas; $i++): ?>
                            <a href="?pagina=<?= $i ?>&buscaTipo=<?= urlencode($buscaTipo) ?>&ordenarPor=<?= $ordenarPor ?>&ordem=<?= $ordem ?>"
...
<div class="modal fade" id="modalDeleteTipo" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-body text-center p-4">
                ...
                <p class="text-muted mt-2">
                    Tipo:
                    <strong id="deleteNomeTipo"></strong>
                </p>
            ...
            <div class="modal-footer">
                ...
                <form action="../controller/controllerTipo.php" method="POST">

                    <input type="hidden" name="id" id="deleteIdTipo">
...
<script>
const botoesDelete = document.querySelectorAll('.btnDeletarTipo');
...
botoesDelete.forEach(botao => {
    botao.addEventListener('click', function () {
        ...
        document.getElementById('deleteIdTipo').value = id;
        document.getElementById('deleteNomeTipo').innerText = nome;
