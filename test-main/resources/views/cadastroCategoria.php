        ...
        <div class="row g-0">
            ...
            <main class="content col-12 col-md-10">
                <div class="page-header">
                    ...
                    <p>Preencha o formulário abaixo para cadastrar a categoria!</p>
                </div>

                <form action="../../app/Controller/cadastros/cadastro_categoria.php" method="POST" class="form-container">
