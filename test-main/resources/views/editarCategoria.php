    ...
    <div class="container-fluid p-0 dashboard-container">
        <div class="row g-0">
            ...
            <main class="content col-12 col-md-10">
                ...
                <p class="text-muted m-0" style="padding-left: 52px;">Preencha o formulário abaixo para editar a categoria!</p>
                </div>
                    ...
                    <div class="form-section">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="nome" name="nome" value="<?= $categoria['nome'] ?>"placeholder="Nome da Categoria" required>
                            </div>
                        
                        </div>
                    
                        <div class="form-actions">
                            <button type="submit" class="btn-submit">Atualizar Categoria</button>
                        </div>
                    </div>
                </form>
            </main>
