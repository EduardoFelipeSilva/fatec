...
<head>
    ...
    <title>Cadastro de Período</title>
            ...
            <main class="content col-12 col-md-10">
                <div class="page-header">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        ...
                        <h1 class="m-0">Cadastro de Períodos</h1>
                    </div>
                    <p class="text-muted m-0" style="padding-left: 52px;">Preencha o formulário abaixo para cadastrar o período!</p>
                </div>
