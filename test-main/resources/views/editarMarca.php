        ...
        <div class="row g-0">
            ...
            <main class="content col-12 col-md-10">
                <div class="page-header">
                    ...
                    <p class="text-muted m-0" style="padding-left: 52px;">Preencha o formulário abaixo para editar a marca!</p>
                </div>
                    ...
                    <div class="form-section">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="nome" name="nome" value="<?= $marca['nome'] ?>" placeholder="Nome da Marca">
                            </div>
                        
                        </div>
                    
                        <div class="form-actions">
                            <button type="submit" class="btn-submit">Editar Marca</button>
                        </div>
                    </div>
                </form>
            </main>
